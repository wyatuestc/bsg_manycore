...
public:
    ...
    unsigned char    _done_list[ BARRIER_X_DIM ];
...
public:
    ...
    unsigned char    _done_list[ BARRIER_Y_DIM ];
    unsigned int     _local_alert ;
...
tmp_bsg_col_barrier<BSG_TILE_GROUP_Y_DIM> ROW_BARRIER_NAME (y_cord_start, y_cord_end);
